...
self
		.cost = T.mean(T.nnet.categorical_crossentropy(self.noise_py_x, self.Y))
	...
	def save_all_weights(self, task_id):
		self.save_data("saved/task_id/W1.txt", self.w1, gpu = True)
		self.save_data("saved/task_id/W2.txt", self.w2, gpu = True)
		self.save_data("saved/task_id/W3.txt", self.w3, gpu = True)
		self.save_data("saved/task_id/W4.txt", self.w4, gpu = True)
		self.save_data("saved/task_id/Wo.txt", self.wo, gpu = True)

	def load_all_weights(self, task_id):
		self.w1 = self.load_data("saved/task_id/W1.txt", (32, 1, 3, 3), gpu = True)
		self.w2 = self.load_data("saved/task_id/W2.txt", (64, 32, 3, 3), gpu = True)
		self.w3 = self.load_data("saved/task_id/W3.txt", (128, 64, 3, 3), gpu = True)
		self.w4 = self.load_data("saved/task_id/W4.txt", (128 * 3 * 3, 625), gpu = True)
		self.wo = self.load_data("saved/task_id/Wo.txt", (625, 10), gpu = True)
